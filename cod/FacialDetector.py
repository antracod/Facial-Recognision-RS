...
class FacialDetector:
    ...
    def get_positive_descriptors(self):
        ...
        for i in range(num_images):
            ...
            descriptor_img = hog(img,pixels_per_cell=(self.params.dim_hog_cell,self.params.dim_hog_cell),cells_per_block = (2,2))
            positive_descriptors.append(descriptor_img)
            print("Am extras descriptorul pentru imaginea", i, "cu dimensiunea ",descriptor_img.shape)


        positive_descriptors = np.array(positive_descriptors)
        print("Array descriptor de dim",positive_descriptors.shape)
